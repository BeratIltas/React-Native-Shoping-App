export const images = {
  ...
  LoginBackground: require('../assets/Account/LoginBackground.png'),
  Bell64: require('../assets/Account/Bell64.png'),
  SuccessIcon: require('../assets/Account/SuccessIcon.png'),
  Eye: require('../assets/Account/Eye.png'),
  EyeOff: require('../assets/Account/EyeOff.png'),
  addCard: require('../assets/Account/addCard.png'),
  HomeAddress: require('../assets/Account/HomeAddress.png'),
